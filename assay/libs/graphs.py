...
#----------------------------------------------------------------------------------------------------
	...
	def set_styles(self):
		...
		if self.legendBGColor:
			self.__cssLEGENDBG += f'background-color:{self.legendBGColor};'
		...
		if self.absValuesBGColor:
			self.__cssABSVALUES += f'background-color:{self.absValuesBGColor};'
		...
		if self.absValuesSize:
			self.__cssABSVALUES += f'font-size:{str(self.absValuesSize)}px;'
		...
		if self.percValuesSize:
			self.__cssPERCVALUES += f'font-size:{str(self.percValuesSize)}px;'
